...
export class WindowHelper {
  ...
  private step: number = 50; // pixels to move per arrow key press
  ...
  public createWindow(): void {
    ...
    const windowSettings: Electron.BrowserWindowConstructorOptions = {
      ...
      resizable: true,
      movable: true,
      x: Math.floor(workArea.width / 2 - 225), // Center horizontally
      y: Math.floor(workArea.height / 2 - 350), // Center vertically
    };
  ...
  private centerWindow(): void {
    ...
    const windowWidth = windowBounds.width || 450;
    const windowHeight = windowBounds.height || 700;
